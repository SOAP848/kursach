...
=====================================
Модуль параметрического размещения геометрических объектов в заданном
пространстве (аналог Corona Scatter).
...
if _HAS_BPY:
    ...
    def register():
        """Регистрация всех классов и свойств аддона."""
        for cls in CLASSES:
    ...
    def unregister():
        """Отмена регистрации всех классов и свойств аддона."""
